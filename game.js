class EscapeRoom {
    ...
    renderFinal() {
        ...
        roomElement.innerHTML = `
            <div style="position: absolute; width: 100%; height: 100%; display: flex; 
                ...
                <button class="game-button" onclick="game.continuarJogo()">
                    Continuar
                </button>
    ...
    }, 500); // aguarda o fade antes de mudar
}   
}

function irParaProximoMapa(destino) {
  document.body.classList.add('fade');
  setTimeout(() => {
